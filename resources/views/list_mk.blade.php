...
<div class="container mt-5">
    <div style="display:flex; align-items:center; justify-content:space-between; gap:16px; flex-wrap:wrap;">
        ...
        <a href="{{ route('matakuliah.create') }}" style="
    ...
    ">
        <thead style="background: linear-gradient(90deg, #ff80ab, #ff4081); color: white;">
            <tr>
                ...
                <th style="padding: 14px; text-align: left;">Nama Mata Kuliah</th>
                <th style="padding: 14px; text-align: left;">SKS</th>
        ...
        <tbody>
            ...
            <tr style="border-bottom: 1px solid #f5c6cb;">
                <td style="padding: 12px;">{{ $mk->id }}</td>
                <td style="padding: 12px;">{{ $mk->nama_mk }}</td>
                <td style="padding: 12px;">{{ $mk->sks }}</td>
                <td style="padding: 12px; text-align: center;">
                    <a href="{{ route('matakuliah.edit', $mk->id) }}" style="
